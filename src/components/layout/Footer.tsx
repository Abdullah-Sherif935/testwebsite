...
export function Footer() {
    ...
    const socialLinks = [
        {
            label: 'GitHub',
            url: 'https://github.com/Abdullah-Sherif935',
            icon: (
        ...
        {
            label: 'LinkedIn',
            url: 'https://www.linkedin.com/in/abdullah-sherif-abdulraouf',
            icon: (
        ...
        {
            label: 'YouTube',
            url: 'https://www.youtube.com/@EngAbdullah-Sherif',
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            label: 'Facebook',
            url: 'https://www.facebook.com/Abdullahsherif935/',
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
